...
You will be presented with three different file saving dialogs offering you to save the files with the default filenames. The alignment expects you to keep the filenames. Otherwise you need to fix the alignment header manually.
...
\begin{figure}[htb!]
 \includegraphics[width=\textwidth]{screenshots/settings_import.png}
\end{figure}
